...
const HeroSection = () => {
  return (
    ...
    <div className="z-40 xl:mb-0 mb-[20%]">
        ...
        className=
        "text-5xl md:text-7xl lg:text-8xl font-bold z-10 mb-6">
...
<Spline className="absolute xl:right-[-28%] right-0 top-[-20%] lg:top-0 " scene="https://prod.spline.design/wceoKxxjiUyZ3uyp/scene.splinecode" />
