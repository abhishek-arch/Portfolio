...
useEffect(() => {
  ...
  gsap.set(circleRef.current,{scale:1,background:"white"})
...
<div
ref={circleRef}
className="w-24 sm:w-28 md:w-32 h-24 sm:h-28 md:h-32 rounded-full flex items-center justify-center relative transition-shadow duration-1000 shadow-violet-300/50 shadow-lg
bg-gradient-to-r from bg-violet-400 to-pink-100 "
>
...
SCROLL DOWN
    ...
    >
        ...
        >
            Step Into the future with AbhiCoder
        </h1>

        <p className="text-black lg:w-[40rem] w-[20rem] absolute sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068]">
            Full Stack developer specialized in crafting modern, responsive web interfaces using React,Tailwind CSS,Express, NodeJs and advance UI  animation techniques. Focused on clean code, and pixel-perfect design that stand out.
        </p>
        <button
