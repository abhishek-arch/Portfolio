      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="lg:flex hidden space-x-8">
          ...
          <div className="md:flex hidden items-center space-x-4">
            ...
            className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300" href="https://github.com/abhishek-arch">
            ...
            className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300" href="https://www.linkedin.com/in/abhishek-shukla-85136628a/">
      ...
      className="md:hidden overflow-hidden bg-white dark:bg-gray-900 shadow-lg px-4 py-5 space-y-5">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex space-x-5">
                <a href="https://github.com/abhishek-arch">
                    <FiGithub className="h-5 w-5 text-gray-300"/>


                </a>

                <a href="https://www.linkedin.com/in/abhishek-shukla-85136628a/">
             ...
             className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <form className="space-y-4">
                    ...
                    whileTap={{scale:0.97}}
                     ...
                     className="w-full px-4 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-lg hover:shadow-violet-600/50 h-12"
